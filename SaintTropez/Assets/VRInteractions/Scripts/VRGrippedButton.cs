...
public class VRGrippedButton : MonoBehaviour {
	...
	/// </summary>
	VRButton Button;
	public SteamVR_Action_Boolean triggerPressAction = SteamVR_Actions.default_TriggerPress; // Replace 'default_TriggerPress' with your actual action path
...
/*	/// <summary>
	...
	public void ActivateButton(Rigidbody _controllerBody)
	{
		...
		SteamVR_Behaviour_Pose controllerPose = _controllerBody.gameObject.GetComponent<SteamVR_Behaviour_Pose>();

		if (controllerPose == null)
			return;

		if (triggerPressAction.GetState(controllerPose.inputSource))
		{
			if (ButtonAnim != null)
				ButtonAnim.Play();
		}
